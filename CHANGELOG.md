...
### Changed - Beta Version Display
- Beta tag now shows deployment version: "Beta v157" instead of just "BETA"
- `deploy.sh` extracts @version from clasp and sets `DEPLOYMENT_VERSION` Script Property
- Added `adminSetDeploymentVersion()` API for deploy script to call
- Browser tab title shows deployment version for beta: "Chess Tracker (Beta v157)"
